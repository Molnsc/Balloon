    ...
    const cheat = (async () => {
        ...
        const guiWrapper = createElement("div", {
            ...
            (variables = createElement("style", {
                id: "variables",
                innerHTML: `:root {--backgroundColor: ${Settings.data?.theme?.backgroundColor || "rgb(20, 20, 20)"};--infoColor: ${Settings.data?.theme?.infoColor || "#18191a"};--cheatList: ${Settings.data?.theme?.cheatList || "#18191a"};--defaultButton: ${Settings.data?.theme?.defaultButton || "#18191a"};--disabledButton: ${Settings.data?.theme?.disabledButton || "#A02626"};--enabledButton: ${Settings.data?.theme?.enabledButton || "#47A547"};--textColor: ${Settings.data?.theme?.textColor || "white"};--inputColor: ${Settings.data?.theme?.inputColor || "#222021"};--contentBackground: ${Settings.data?.theme?.contentBackground || "rgb(13, 13, 13)"};}`
            })),
            createElement("style", {
            ...
            (gui = createElement("div", {
                ...
                createElement("div", {
                    ...
                    innerHTML: "Balloon v1.0.2",
                    onclick: () => window.open("https://caleb.vip/mod-menu.script", "_blank").focus()
                }),
                ...
                (cheatContainer = createElement("div", {
                    ...
                    innerHTML: "<span style=\"text-shadow: 1px 1px rgb(0 0 0 / 40%)\">Mod Menu</span>"
                },
                    createElement("a", {
                        className: "bigButton",
                        style: {
